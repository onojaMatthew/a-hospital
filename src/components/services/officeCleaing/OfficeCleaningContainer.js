...
import OfficeCleaningServices from "./OfficeCleaningServices";
import OfficeCleaningSummary from "./OfficeCleaningSummary";
import UserDetails from "./UserDetails";

export default class OfficeCleaningContainer extends Component{
    state = {
        type:1
    };
    ...
    render(){
        ...
        return(
            <div>
                ...
                {{
                    1: <OfficeCleaningServices />,
                    2: <OfficeCleaningSummary />,
                    3: <UserDetails />
                }[type]}
