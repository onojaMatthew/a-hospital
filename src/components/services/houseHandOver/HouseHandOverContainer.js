...
import HouseHandOverServices from "./HouseHandOverServices";
import HouseHandOverSummary from './HouseHandOverSummary';
import UserDetails from "./UserDetails";

export default class HouseHandoverContainer extends Component{
    state={
        type: 1
    };
    ...
    render(){
        ...
        return(
            <div>
                ...
                {{
                    1: <HouseHandOverServices />,
                    2: <HouseHandOverSummary />,
                    3: <UserDetails />
                }[type]}
